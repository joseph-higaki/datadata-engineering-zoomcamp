{#
    THis macro
#}
{% macro get_raw_green_tripdata_columns() -%}
    {{ dbt.cast("VendorID", api.Column.translate_type("int")) }} as VendorID,
    {{ dbt.cast("lpep_pickup_datetime", api.Column.translate_type("timestamp")) }} as lpep_pickup_datetime,
    {{ dbt.cast("lpep_dropoff_datetime", api.Column.translate_type("timestamp")) }} as lpep_dropoff_datetime,
    ...
    {{ dbt.cast("ehail_fee", api.Column.translate_type("numeric")) }} as ehail_fee,
    {{ dbt.cast("trip_type", api.Column.translate_type("int")) }} as trip_type
{%-endmacro-%}    